      ...
      <Grid container item xs={12} style={{ marginTop: 100 }}>
        ...
        <Grid item xs={6} style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
          ...
          <div style={{ marginTop: 30 }}>
            <Button variant="outlined" style={{ borderRadius: 20, marginRight: 10 }} onClick={handleLogin}>Login</Button>
            <Button variant="outlined" style={{ borderRadius: 20 }} onClick={handleRegister}>Register</Button>
          </div>
        </Grid>
      </Grid>
