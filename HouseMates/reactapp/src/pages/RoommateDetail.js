    ...
    <div className={classes.card}>
      <Card>
        ...
        <CardContent className={classes.content}>
          <Avatar className={classes.avatar} src="mrbean.jpg" />
          ...
          <div>
            <div className={classes.category}>
              ...
              <Chip
                className={classes.tag}
                label={roommate.nationality}
                color="primary"
              />
              <Chip
                className={classes.tag}
                label={roommate.introvertExtrovert}
                color="primary"
              />
              <Chip
                className={classes.tag}
                label={roommate.catDog}
                color="primary"
              />
            </div>
            ...
            <div className={classes.category}>
              ...
              <Chip
                className={classes.tag}
                label={roommate.company}
                color="primary"
              />
              <Chip
                className={classes.tag}
                label={roommate.shift}
                color="primary"
              />
            </div>
            ...
            <div className={classes.category}>
              ...
              <Chip
                className={classes.tag}
                label={roommate.smoker}
                color="primary"
              />
              <Chip
                className={classes.tag}
                label={roommate.alcoholic}
                color="primary"
              />
              <Chip
                className={classes.tag}
                label={roommate.sleepingTime}
                color="primary"
              />
              <Chip
                className={classes.tag}
                label={roommate.religion}
                color="primary"
              />
              <Chip
                className={classes.tag}
                label={roommate.dietary}
                color="primary"
              />
            </div>
